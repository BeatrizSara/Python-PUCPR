...
# def listar_clientes(clientes): Isto define a função listar_clientes que aceita um único argumento clientes. A lista clientes deve conter os nomes dos clientes.
...
# return None - Finalmente, a função retorna None. Em Python, é convencional retornar None quando uma função 
# ..não tem um resultado significativo para retornar. Neste caso, a função listar_clientes realiza uma ação (imprimir os nomes dos clientes), mas não tem um resultado "útil" para retornar.