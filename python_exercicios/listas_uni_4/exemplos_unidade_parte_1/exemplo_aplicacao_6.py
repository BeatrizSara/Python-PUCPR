""" 
Exemplo de aplicação 6: Solicite ao usuário que digite três coordenadas (x, y), 
...
# Começamos criando uma lista vazia chamada coordenadas, 
# que servirá para armazenar as coordenadas fornecidas pelo usuário.

# Em seguida, entramos em um laço "for" que será executado três vezes (de 0 a 2). 
# i termina como i = 2 ao verificar com break point - run and debug
